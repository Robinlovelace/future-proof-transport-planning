...
if (!file.exists("locations.geojson")) {
  locations = read_csv("locations.csv")
  locations_lonlat = sapply(locations$address, stplanr::geo_code)
  ...
  sf::write_sf(locations_sf, "locations.geojson")
} else {
  locations_sf = read_sf("locations.geojson")
}
locations_sf_until = locations_sf |>
  mutate(
