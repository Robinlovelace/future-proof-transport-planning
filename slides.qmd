...
## Hereford {.center background-image="images/paste-15.png"}
...
- Where I was born seems a good place to start
- It wasn't this house, but was in the same location
...
# Sheffield {.center background-image="images/paste-41.png" background-opacity="0.5" background-size="70%"}
...
Source: [acteng.github.io](https://acteng.github.io/atip/pipeline/scheme.html?authority=LAD_Leeds&schema=pipeline&style=streets#13.6/53.82231/-1.51541). Credit: Dustin Carlino (Alan Turing Institute and Active Travel England) and colleagues in ATE.
