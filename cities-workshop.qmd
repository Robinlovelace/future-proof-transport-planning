...
author:
  - name: <a href="https://www.robinlovelace.net/talk/seminar-in-st-andrews-future-proof-transport-planning/">Cleaner and Healthier Cities Workshop</a><br>Robin Lovelace
...
::::: columns
::: {.column width="40%"}
"In essence ‘open access’ goes beyond ‘open source’ in that users are ... are encouraged [view and edit the source code], with measures taken in the software itself, and the community that builds it, to make it more user-friendly.""
